...
<head>
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav" style="">
						<li class="grey dropdown-modal">
							<a data-toggle="dropdown" class="dropdown-toggle" href="http://ace.jeka.by/#">
						...
						<li class="green dropdown-modal">
							...
							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li class="dropdown-content ace-scroll" style="position: relative;"><div class="scroll-track" style="display: none;"><div class="scroll-bar"></div></div><div class="scroll-content" style="max-height: 200px;">
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="http://ace.jeka.by/#" class="clearfix">
												<img src="statics/photo/avatar.png" class="msg-photo" alt="Alex&#39;s Avatar">
												<span class="msg-body">
										...
										<li>
											<a href="http://ace.jeka.by/#" class="clearfix">
												<img src="statics/photo/avatar3.png" class="msg-photo" alt="Susan&#39;s Avatar">
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="http://ace.jeka.by/#" class="clearfix">
												<img src="statics/photo/avatar4.png" class="msg-photo" alt="Bob&#39;s Avatar">
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="http://ace.jeka.by/#" class="clearfix">
												<img src="statics/photo/avatar2.png" class="msg-photo" alt="Kate&#39;s Avatar">
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="http://ace.jeka.by/#" class="clearfix">
												<img src="statics/photo/avatar5.png" class="msg-photo" alt="Fred&#39;s Avatar">
												<span class="msg-body">
													<span class="msg-title">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="http://ace.jeka.by/#" class="dropdown-toggle">
								<img class="nav-user-photo" src="statics/photo/user.jpg" alt="Jason&#39;s Photo">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="http://ace.jeka.by/#">Home</a>
							</li>
	...
	лёгкий, многофункциональный и простой в использовании шаблон для админки на bootstrap 3.3.6. Загрузить исходники с <a href="https://github.com/bopoda/ace">github</a> (with minified ace js/css files).
												...
												<div class="widget-toolbar no-border">
													<div class="inline dropdown-hover">
														...
														<ul class="dropdown-menu dropdown-menu-right dropdown-125 dropdown-lighter dropdown-close dropdown-caret">
															<li class="active">
																<a href="http://ace.jeka.by/#" class="blue">
										...
										<div class="widget-box transparent">
											<div class="widget-header widget-header-flat">
												...
												<div class="widget-toolbar">
													<a href="http://ace.jeka.by/#" data-action="collapse">
										...
										<div class="widget-box transparent">
											...
											<div class="widget-body">
												<div class="widget-main padding-4">
													<div id="sales-charts" style="width: 100%; height: 220px; padding: 0px; position: relative;"><canvas class="flot-base" width="958" height="220" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 958px; height: 220px;"></canvas><div class="flot-text" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);"><div class="flot-x-axis flot-x1-axis xAxis x1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;"><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 33px; text-align: center;">0.0</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 106px; text-align: center;">0.5</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 179px; text-align: center;">1.0</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 252px; text-align: center;">1.5</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 325px; text-align: center;">2.0</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 399px; text-align: center;">2.5</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 472px; text-align: center;">3.0</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 545px; text-align: center;">3.5</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 618px; text-align: center;">4.0</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 692px; text-align: center;">4.5</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 765px; text-align: center;">5.0</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 838px; text-align: center;">5.5</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 68px; top: 201px; left: 911px; text-align: center;">6.0</div></div><div class="flot-y-axis flot-y1-axis yAxis y1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;"><div class="flot-tick-label tickLabel" style="position: absolute; top: 187px; left: 1px; text-align: right;">-2.000</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 164px; left: 1px; text-align: right;">-1.500</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 140px; left: 1px; text-align: right;">-1.000</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 117px; left: 1px; text-align: right;">-0.500</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 94px; left: 5px; text-align: right;">0.000</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 70px; left: 5px; text-align: right;">0.500</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 47px; left: 5px; text-align: right;">1.000</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 23px; left: 5px; text-align: right;">1.500</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 0px; left: 5px; text-align: right;">2.000</div></div></div><canvas class="flot-overlay" width="958" height="220" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 958px; height: 220px;"></canvas><div class="legend"><div style="position: absolute; width: 70px; height: 66px; top: 14px; right: 14px; background-color: rgb(255, 255, 255); opacity: 0.85;"> </div><table style="position:absolute;top:14px;right:14px;;font-size:smaller;color:#545454"><tbody><tr><td class="legendColorBox"><div style="border:1px solid #ccc;padding:1px"><div style="width:4px;height:0;border:5px solid rgb(237,194,64);overflow:hidden"></div></div></td><td class="legendLabel">Domains</td></tr><tr><td class="legendColorBox"><div style="border:1px solid #ccc;padding:1px"><div style="width:4px;height:0;border:5px solid rgb(175,216,248);overflow:hidden"></div></div></td><td class="legendLabel">Hosting</td></tr><tr><td class="legendColorBox"><div style="border:1px solid #ccc;padding:1px"><div style="width:4px;height:0;border:5px solid rgb(203,75,75);overflow:hidden"></div></div></td><td class="legendLabel">Services</td></tr></tbody></table></div></div>
												</div><!-- /.widget-main -->
											</div><!-- /.widget-body -->
										</div><!-- /.widget-box -->
									</div><!-- /.col -->
											...
											<div class="widget-header">
												...
												<div class="widget-toolbar no-border">
													<ul class="nav nav-tabs" id="recent-tab">
														<li class="active">
															<a data-toggle="tab" href="http://ace.jeka.by/#task-tab">Tasks</a>
														</li>

														<li>
															<a data-toggle="tab" href="http://ace.jeka.by/#member-tab">Members</a>
														</li>

														<li>
															<a data-toggle="tab" href="http://ace.jeka.by/#comment-tab">Comments</a>
														</li>
													</ul>
												</div>
											</div>
															...
															<ul id="tasks" class="item-list ui-sortable">
																...
																<li class="item-red clearfix ui-sortable-handle">
																	...
																	<div class="pull-right action-buttons">
																		...
																		<a href="http://ace.jeka.by/#" class="red">
																			<i class="ace-icon fa fa-trash-o bigger-130"></i>
																		</a>

																		<span class="vbar"></span>

																		<a href="http://ace.jeka.by/#" class="green">
																...
																<li class="item-default clearfix ui-sortable-handle">
																	...
																	<div class="pull-right pos-rel dropdown-hover">
																		...
																		<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-caret dropdown-close dropdown-menu-right">
																			<li>
																				<a href="http://ace.jeka.by/#" class="tooltip-success" data-rel="tooltip" title="" data-original-title="Mark as done">
																					<span class="green">
																			...
																			<li>
																				<a href="http://ace.jeka.by/#" class="tooltip-error" data-rel="tooltip" title="" data-original-title="Delete">
																					<span class="red">
														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe&#39;s avatar" src="statics/photo/user.jpg">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Bob Doe</a>
																		</div>
																		...
																		<div>
																			...
																			<div class="inline position-relative">
																				...
																				<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																					<li>
																						<a href="http://ace.jeka.by/#" class="tooltip-success" data-rel="tooltip" title="" data-original-title="Approve">
																							<span class="green">
																								<i class="ace-icon fa fa-check bigger-110"></i>
																							</span>
																						</a>
																					...
																					<li>
																						<a href="http://ace.jeka.by/#" class="tooltip-warning" data-rel="tooltip" title="" data-original-title="Reject">
																							<span class="orange">
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe&#39;s avatar" src="statics/photo/avatar2.png">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Joe Doe</a>
																		</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe&#39;s avatar" src="statics/photo/avatar.png">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Jim Doe</a>
																		</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe&#39;s avatar" src="statics/photo/avatar5.png">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Alex Doe</a>
																		</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe&#39;s avatar" src="statics/photo/avatar2.png">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan&#39;s avatar" src="statics/photo/avatar3.png">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Susan</a>
																		</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe&#39;s avatar" src="statics/photo/avatar4.png">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Phil Doe</a>
																		</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe&#39;s avatar" src="statics/photo/avatar1.png">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Alexa Doe</a>
																		</div>
															...
															<div class="center">
																...
																&nbsp;
																<a href="http://ace.jeka.by/#" class="btn btn-sm btn-white btn-info">
																	See all members &nbsp;
																	<i class="ace-icon fa fa-arrow-right"></i>
																</a>
															</div>
														...
														<div id="comment-tab" class="tab-pane">
															<div class="comments ace-scroll" style="position: relative;"><div class="scroll-track" style="display: none;"><div class="scroll-bar"></div></div><div class="scroll-content" style="max-height: 300px;">
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Bob Doe&#39;s Avatar" src="statics/photo/avatar.png">
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer&#39;s Avatar" src="statics/photo/avatar1.png">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Jennifer</a>
																		</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Joe&#39;s Avatar" src="statics/photo/avatar2.png">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Joe</a>
																		</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Rita&#39;s Avatar" src="statics/photo/avatar3.png">
																	</div>

																	<div class="body">
																		<div class="name">
																			<a href="http://ace.jeka.by/#">Rita</a>
																		</div>
												...
												<div class="widget-main no-padding">
													<div class="dialogs ace-scroll"><div class="scroll-track scroll-active" style="display: block; height: 300px;"><div class="scroll-bar" style="height: 262px; top: 0px;"></div></div><div class="scroll-content" style="max-height: 300px;">
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Alexa&#39;s Avatar" src="statics/photo/avatar1.png">
															</div>
															...
															<div class="body">
																...
																<div class="name">
																	<a href="http://ace.jeka.by/#">Alexa</a>
																</div>
																<div class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque commodo massa sed ipsum porttitor facilisis.</div>

																<div class="tools">
																	<a href="http://ace.jeka.by/#" class="btn btn-minier btn-info">
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="John&#39;s Avatar" src="statics/photo/avatar.png">
															</div>
															...
															<div class="body">
																...
																<div class="name">
																	<a href="http://ace.jeka.by/#">John</a>
																</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob&#39;s Avatar" src="statics/photo/user.jpg">
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Jim&#39;s Avatar" src="statics/photo/avatar4.png">
															</div>
			...
			<a href="http://ace.jeka.by/#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
...
<![endif]-->
		...
		<script src="statics/js/jquery.sparkline.index.min.js"></script>
